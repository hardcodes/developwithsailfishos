...
\bibitem [sailfishos4]{sailfishos4} SailfishOS open source code \\\url{http://releases.sailfishos.org/sdk/latest/}
...
%
%
\bibitem[nemo01]{nemo01} Nemo Mobile on Github \\\url{https://github.com/nemomobile}
%
%
...
\bibitem[fd02]{fd02} FreeDesktop - pkg-config \\\url{http://www.freedesktop.org/wiki/Software/pkg-config/}
