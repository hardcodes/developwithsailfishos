...
%
Some community members have figured out that the NFC chip causes quite heavy battery draining. If you don't need the chip for now, there is a way to stop the underlying service. Login your device and enter
%
\begin{lstlisting}[language=bash]
