...
\end{figure}
%
If your app is almost ready to ship to the \nameref{harbour}, you can change to \emph{RPM}. Now your compiled files will be packaged into a RPM file, transferred to the target device and installed like any other application from the store.
%
\begin{figure}[H]
  \centering
