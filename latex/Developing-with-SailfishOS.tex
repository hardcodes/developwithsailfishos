...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.3]{../media/gfx/silica/emulatorexample.png} 
...
\\
\\
Inside the VirtualBox manual is a section that may describe the cause for these problems\cite{vbox02}, as it talks about slow disk systems and that is truly the case here. I am testing this right now, don't know yet if that really helps = call this experimental.
...
# the 0 in 'Storage Controller Name (0)' is what we are looking for
# it translates to the 0 in 'LUN#0' in the following command
VBoxManage setextradata "MerSDK" "VBoxInternal/Devices/ahci/0/LUN#0/Config/FlushInterval" 5000000
...
\bibitem[vbox02]{vbox02} Guest shows IDE/SATA errors for file-based images on slow host file system\\\url{http://www.virtualbox.org/manual/ch12.html#idp59864608}
%
%
