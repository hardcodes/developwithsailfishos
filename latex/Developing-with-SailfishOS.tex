...
\subsection{Windows}
%
Double click the $\vcenter{\hbox{\includegraphics[scale=0.6]{./gfx/vboxinstaller.png}}}$ executable that you have downloaded and follow the installer.
%
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.6]{./gfx/vboxinstwin01.png} 
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.6]{./gfx/vboxinstwin02.png} 
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.6]{./gfx/vboxinstwin03.png} 
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.6]{./gfx/vboxinstwin04.png} 
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.6]{./gfx/vboxinstwin05.png} 
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.6]{./gfx/vboxinstwin06.png} 
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.6]{./gfx/vboxinstwin07.png} 
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.6]{./gfx/vboxinstwin08.png} 
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.6]{./gfx/vboxinstwin09.png} 
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.6]{./gfx/vboxinstwin10.png} 
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.6]{./gfx/vboxinstwin11.png} 
  \caption{Install VirtualBox, Step 11.}
  \label{fig:vboxinstwin11}
\end{figure}
%
Start the $\vcenter{\hbox{\includegraphics[scale=0.6]{./gfx/sfosinstaller.png}}}$ executable and install the SDK.
%
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.6]{./gfx/installsdkwin01.png} 
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.6]{./gfx/installsdkwin02.png} 
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.6]{./gfx/installsdkwin03.png} 
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.6]{./gfx/installsdkwin04.png} 
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.6]{./gfx/installsdkwin05.png} 
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.6]{./gfx/installsdkwin06.png} 
  \caption{Install VirtualBox, Step 6.}
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.6]{./gfx/installsdkwin07.png} 
  \caption{Install VirtualBox, Step 7.}
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.6]{./gfx/installsdkwin08.png} 
  \caption{Install VirtualBox, Step 8.}
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.6]{./gfx/installsdkwin09.png} 
  \caption{Install VirtualBox, Step 9.}
  \label{fig:installsdkwin09}
\end{figure}
%
Start the maintenance tool from the start menu and update all components.
%
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.6]{./gfx/sdkwinstartmenu.png} 
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.6]{./gfx/saddirwin01.png} 
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.6]{./gfx/saddirwin02.png} 
  \caption{Directory after installation.}
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.6]{./gfx/newsailfishproject01.png} 
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.4]{./gfx/managesdkupdate.png} 
...
%
You can use additional libraries for your code, so you don't have to write all functionality for yourself. Some of them are available on the emulator and the physical device later on. Sadly not all library packages that are available for Nemo/Mer are usable here. Have look in section \nameref{harbor} on \pageref{harbour} for details about allowed packages. That does not mean, that you can not use libraries that are not part of SailfishOS. You can deliver them with your app, linked to the correct location. Mind the problems\footnote{Think security updates.} that you inherit by doing so.
%
%
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.4]{./gfx/MerSDKsettings.png} 
...
sylimikro:~ sven$ ssh -p 2222 nemo@localhost
...
# check again
ps -ef | grep sshd
root    534   1  2:06pm tty2    0:00.01 /usr/sbin/sshd -D -f /etc/ssh/sshd_config_engine
root    535   1  2:06pm tty2    0:00.01 grep sshd
\end{lstlisting}
%
...
\end{lstlisting}
It may even happen that your public key is missing, check with
\begin{lstlisting}[language=bash]
ls ~/.ssh/mer-qt-creator-rsa
ls: /Users/sven/.ssh/mer-qt-creator-rsa: No such file or directory
\end{lstlisting}
%
Right at the moment I am not sure when the key files are delivered. At install time would make sense but here must investigate further. Ok, I have demoved them during the last uninstall but shouldn't they come with a new install?
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.5]{./gfx/vboxmersdkcheckdrives.png} 
...
TODO talk about the other drives.
TODO maybe caused by missing VBox extension pack
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.6]{./gfx/vboxisupdateavailable.png} 
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.6]{./gfx/vboxupateavailable.png} 
...
TODO check if we can do that via the SDKMaintenanceTool - how to invalidate the VM image?
%

One one machine the VM was running but slow\footnote{As in tar pit.}, so every connection attempt timed out. Even control from VirtualBox itself was almost impossible. Until now I found no solution for this.

TODO find out if installing the Guest Additions helps.
%
%
\subsubsection{update via command line}
%
TODO
%
%
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.6]{./gfx/OSXSDKMaintenaceTool.png} 
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.6]{./gfx/osxuninstall01.png} 
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.6]{./gfx/osxuninstall02.png} 
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.6]{./gfx/osxuninstall03.png} 
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.6]{./gfx/osxuninstall04.png} 
...
%
\begin{lstlisting}[language=bash]
# I've seen conflicts with changing ssh keys. Remove to prevent that
# (you may want to install again later on)
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.6]{./gfx/osxuninstall05.png} 
