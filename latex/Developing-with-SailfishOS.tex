...
\end{figure}
%
When the virtual machine with the SDK is running, apply updates if necessary\footnote{For some users (this includes me), the management webpage is not shown, instead there is an empty webpage ("about:blank"). Type "127.0.0.1:8080" as URL and hit <Enter> (the complete URL is http://127.0.0.1:8080/C/targets/).}.
\begin{figure}[H]
  \centering
...
%
%
\subsubsection{Known Logins}{subsubsec:emulatorlogins}
%
TODO
%
%
...
%
%
\subsubsection{Directories}{subsubsec:mersdkdirectories}
%
TODO
%
%
