...
Starting Nmap 6.25 ( http://nmap.org ) at 2013-12-03 07:33 CET
...
\end{lstlisting}
%
TODO add public key to \verb,authorized_keys, if missing
%
...
\end{figure}
%
To make it really clean, remove orphaned files and directories.
%
\begin{lstlisting}[language=bash]
