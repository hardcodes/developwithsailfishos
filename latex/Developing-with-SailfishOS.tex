...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.6]{./gfx/QtCreatorUpdateNeeded.png} 
...
\end{lstlisting}
%
Right at the moment I am not sure when the key files are delivered. At install time would make sense but here must investigate further. Ok, I have removed them during the last uninstall but shouldn't they come with a new install? Solution for me was to copy them from another machine but that's just a dirty workaround.
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.6]{./gfx/vboxtarpit.png} 
...
# You may want to install the SDK again later on. But I have also seen
# installs where the keys were not created anymore :-/
